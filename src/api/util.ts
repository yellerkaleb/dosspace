import { all, findOne, insert, update,reset,testWrite,addTable } from './db/db'
...
export function addWorkspaceTable(dbString:string,id:string,newTable:Workspace):Workspace{
